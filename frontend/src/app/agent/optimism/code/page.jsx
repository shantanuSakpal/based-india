...
export default function Editor() {
  ...
  const DeployContract = async () => {
    ...
    try {
      ...
      // Check if the user is on the correct network (Optimism Testnet)
      const network = await provider.getNetwork();
      if (network.chainId !== 31) {
        toast.error("Please switch to the Optimism Testnet in MetaMask.");
        return;
      }
      // console.log("Connected to Optimism Testnet.");
      setIsDeploying(true);
